...
#ifdef WIN32
	// почему это вообще надо?.. лишний байт дл€ чтени€ в глупых редакторах, не поддерживающих LF онли? или что?.. 
	// а если уж и нужно, то вообще надо бы сделать константу, дефайн, завис€щий от платформы..
...
//	Log("----------", "");
	...
	SetCurrentDirectory(TempDir);	// ≈бано как-то, но таки хуй с ним.
